...
ALTER TABLE STATUT_MEDECIN ADD CONSTRAINT pkStatutMedic PRIMARY KEY (idstatutmedecin);

ALTER TABLE COMMANDE ADD CONSTRAINT fkCommandeMedicament FOREIGN KEY (idcommande) REFERENCES EMPLOYE (idcommande);
...
ALTER TABLE EMPLOYE ADD CONSTRAINT fkEmployeStatutmedic FOREIGN KEY (idstatutmedecin) REFERENCES EMPLOYE (idstatutemploye); 
