...
-------------------------------------------------------------------------------
-- Récupère tous les traitement ayant le statut (1 = Requête, 2 = Disponible, 3 = Livré, 4 = Appliqué)
SELECT TRAITEMENT.ID, DATETRAITEMENT, DATEFINTRAITEMENT, IDPATIENT FROM TRAITEMENT
JOIN STATUT ON STATUT.ID = TRAITEMENT.IDSTATUT
WHERE STATUT.ID = x; --1, 2, 3 ou 4
